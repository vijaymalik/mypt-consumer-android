...
class NotificationPaymentSelectionActivity : AppCompatActivity() {
    var payment_id=""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_notification_payment_selection)
        ...
        linearPay.setOnClickListener{
            if (isSelected){
                ...
                if (selectedPaymentOption == "debit"){
                    ...
                    intent.putExtra("payment_type","ccavenue")
    ...
    private fun onCheckoutResult(tabbyResult: TabbyResult) {
        ...
        when (tabbyResult.result) {
            TabbyResult.Result.AUTHORIZED -> {
                ...
                val intent = Intent(this@NotificationPaymentSelectionActivity,
                    NotificationBookingConfirmActivity::class.java)

                intent.putExtra("booking_id",getIntent().getStringExtra("booking_id"))
                intent.putExtra("price",getIntent().getStringExtra("price"))
                intent.putExtra("transaction_id",payment_id)
                intent.putExtra("payment_type","tabby")
                intent.putExtra("address_id",getIntent().getStringExtra("address_id"))
                startActivity(intent)
            }
    ...
    private fun alerDialog(message:String){
        val builder = AlertDialog.Builder(this@NotificationPaymentSelectionActivity)
