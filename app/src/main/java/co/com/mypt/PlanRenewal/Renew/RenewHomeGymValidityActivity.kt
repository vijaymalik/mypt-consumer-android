...
class RenewHomeGymValidityActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvcontinue.setOnClickListener{
            val intent1 = Intent(this@RenewHomeGymValidityActivity, RenewHomeGymReviewActivity::class.java)
    ...
    private fun getSessionData(checkedType: String) {
        val progressDialog: Dialog = ProgressDialog.progressDialog(this@RenewHomeGymValidityActivity,"")
        progressDialog.show()

        GetMethod(ApiURL.upgradeTopUpPlan+"renew&sessions=$sessions&id=${intent.getStringExtra("id")}&days=$progressDays",
            this@RenewHomeGymValidityActivity).startMethod(object :
            ResponseData {
            override fun response(data: String?) {
                progressDialog.dismiss()

                Log.e("renewValidityResp",data.toString())
                try {
