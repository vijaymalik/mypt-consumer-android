...
class ChooseSessionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvcontinue.setOnClickListener{
            val intent1 = Intent(this@ChooseSessionActivity, ValidityOfPackageActivity::class.java)
    ...
    private fun getSessionData(checkedType: String) {
        ...
        progressDialog.show()
        Log.e("upgradeTopupapi",""+ApiURL.upgradeTopUpPlan+"upgrade&sessions=$sessions&id=${intent.getStringExtra("id")}")
        GetMethod(ApiURL.upgradeTopUpPlan+"upgrade&sessions=$sessions&id=${intent.getStringExtra("id")}",this@ChooseSessionActivity).startMethod(object :
            ResponseData {
            override fun response(data: String?) {
                progressDialog.dismiss()

                Log.e("upgradePackageResponse",data.toString())
                try {
