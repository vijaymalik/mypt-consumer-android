package co.com.mypt.PlanRenewal.Renew.Gym
...
import co.com.mypt.adapter.RenewGymListAdapter
...
class RenewGymListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_renew_gym_list)
            ...
            override fun response(data: String?) {
                ...
                try {
                    ...
                    if (jsonObj.optBoolean("status")){
                        ...
                        exerciseRecyclerView.adapter = GymListExerciseAdapter(this@RenewGymListActivity,exerciseList)
                ...
                try {
                    ...
                    if (jsonObj.optBoolean("status")){
                        ...
                        if (jsonArrayList.length()>0){
                            ...
                            trainerRecyclerView.adapter = RenewGymListAdapter(this@RenewGymListActivity,trainerList,"renew","gym",latitude,longitude)
