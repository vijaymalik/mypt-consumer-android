...
class HomeTotalSessionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvcontinue.setOnClickListener{
            val intent1 = Intent(this@HomeTotalSessionActivity, HomeValidityActivity::class.java)
            intent1.putExtra("typeSubsctiption",intent.getStringExtra("typeSubsctiption"))
            startActivity(intent1)
        }
        cardEdit.setOnClickListener{
            /*val intent = Intent(this@HomeTotalSessionActivity, TrainersListActivity::class.java)
