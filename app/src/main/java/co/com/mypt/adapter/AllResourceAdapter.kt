...
class AllResourceAdapter(var applicationContext: Context?, var resourceModelList: ArrayList<ResourceModel>) :
    RecyclerView.Adapter<AllResourceAdapter.ResourceHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AllResourceAdapter.ResourceHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.allresource_layout, parent, false)
        return ResourceHolder(view)
    }

    override fun onBindViewHolder(holder: AllResourceAdapter.ResourceHolder, position: Int) {
