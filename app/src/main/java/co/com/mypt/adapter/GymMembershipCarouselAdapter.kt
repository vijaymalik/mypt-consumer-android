...
class GymMembershipCarouselAdapter (val data: List<BestPlanData?>):
    RecyclerView.Adapter<GymMembershipCarouselAdapter.CarouselVH>() {

//    private val items = List(10) { it }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CarouselVH {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.gym_membership_carousel_item, parent, false)
    ...
    override fun onBindViewHolder(holder: CarouselVH, position: Int) {
        ...
        holder.tvValidDays.text=item?.validity_text?:""
    ...
    class CarouselVH(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var tvValidDays = itemView.findViewById<TextView>(R.id.tvValidDays)
