...
import co.com.mypt.BookingScreen.CancelBookingDetailActivity
import co.com.mypt.BookingScreen.CompletedBookingDetailActivity
import co.com.mypt.R

import co.com.mypt.model.CancelbokingModel

class CancelBookingAdapter(var activity: FragmentActivity?, var cancelBookkingModelList: ArrayList<CancelbokingModel>) : RecyclerView.Adapter<CancelBookingAdapter.CancelBookingHolder>() {
    class CancelBookingHolder(view: View):RecyclerView.ViewHolder(view){
    ...
    override fun onCreateViewHolder(
        ...
        return CancelBookingHolder(view)
    }

    override fun onBindViewHolder(holder: CancelBookingHolder, position: Int) {
        var upcomingbokingModel= cancelBookkingModelList[position]
        ...
        holder.linear.setOnClickListener{
            ...
            var upcomingbokingModel= cancelBookkingModelList[pos]
            var intent= Intent(activity, CancelBookingDetailActivity::class.java)
    ...
    override fun getItemCount(): Int {
       return cancelBookkingModelList.size
    }
