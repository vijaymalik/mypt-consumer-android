...
import co.com.mypt.Profile.ProfileTrainerDetailActivity
...
class ProfileTrainerListAdapter(var context: Context?, var trainerList: ArrayList<TrainersModel>, var type: String, var typeWorkout: String?, var latitude: Double?, var longitude: Double?, var studioId: String) :
    RecyclerView.Adapter<ProfileTrainerListAdapter.TrainerDetailHolder>() {
    lateinit var sharedPreferences: SharedPreferences
    private var trainerListModels: List<TrainersModel>
    class TrainerDetailHolder(item: View):RecyclerView.ViewHolder(item) {
    ...
    override fun onCreateViewHolder(
        ...
        val view = if(type == "Linear")
            LayoutInflater.from(parent.context).inflate(R.layout.profile_trainer_list_linear_adapter_layout, parent, false)
        else
            LayoutInflater.from(parent.context).inflate(R.layout.profile_trainer_list_grid_adapter_layout, parent, false)
        return TrainerDetailHolder(view)
    }

    override fun onBindViewHolder(holder: TrainerDetailHolder, position: Int) {
        ...
        holder.relative.setOnClickListener {
            ...
            val intent = Intent(context, ProfileTrainerDetailActivity::class.java)
    ...
    fun filterList(filteredList: MutableList<TrainersModel>) {
        this.trainerListModels = filteredList
        // below line is to notify our adapter
        // as change in recycler view data.
        notifyDataSetChanged()
        Log.e("filterList", "Filtered list: ${trainerListModels.size}")
    }
