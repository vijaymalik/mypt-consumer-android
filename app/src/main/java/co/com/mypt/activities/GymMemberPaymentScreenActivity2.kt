...
import co.com.mypt.Webview.MembershipCCavenueWebActivity
...
class GymMemberPaymentScreenActivity2 : AppCompatActivity() {
    var payment_id=""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_gym_member_payment_screen2)
        ...
        linearPay.setOnClickListener{
            if (isSelected){
                ...
                if (selectedPaymentOption == "debit"){
                    val intent = Intent(this, MembershipCCavenueWebActivity::class.java)
    ...
    private fun billBottomSheet() {
        ...
        tvPayable.text = "AED "+intent.getStringExtra("total_price")
    ...
    private fun onCheckoutResult(tabbyResult: TabbyResult) {
        ...
        when (tabbyResult.result) {
            TabbyResult.Result.AUTHORIZED -> {
                ...
                val intent = Intent(this@GymMemberPaymentScreenActivity2, BookMemberShipActivity::class.java)
                intent.putExtra("studio_id",getIntent().getStringExtra("studio_id"))
                intent.putExtra("days",getIntent().getStringExtra("days"))
                intent.putExtra("apistart_date",getIntent().getStringExtra("apistart_date"))
                intent.putExtra("apiend_date",getIntent().getStringExtra("apiend_date"))
    ...
    private fun alerDialog(message:String){
        val builder = AlertDialog.Builder(this@GymMemberPaymentScreenActivity2)
