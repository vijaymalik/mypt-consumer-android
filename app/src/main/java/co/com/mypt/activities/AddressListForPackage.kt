...
class AddressListForPackage : AppCompatActivity() {
    var address_id=""
    var checkType=""
    ...
    lateinit var selectAddressBtn:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        selectAddressBtn.visibility = View.VISIBLE
        bookSlot.visibility = View.GONE
        ...
        selectAddressBtn.setOnClickListener {
            ...
            if (address_id == ""){
                ...
                val intent = Intent("updatedAddressId")
    ...
    val selectAddress = object : BroadcastReceiver(){
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            if (address_id.equals("")){
                ...
                selectAddressBtn.setTextColor(getColor(R.color.subheadingcolor))
                ...
                selectAddressBtn.setTextColor(getColor(R.color.buttontextcolor))
