...
class ChooseLocationActivity : AppCompatActivity()  , OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvContinue.setOnClickListener{
            ...
            intent.putExtra("lati",latitude.toString())
            intent.putExtra("longi",longitude.toString())
            intent.putExtra("chooseAdreess",address)
        ...
        registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted ->
            if (isGranted) {
                ...
                if (!shouldShowRequestPermissionRationale(Manifest.permission.ACCESS_FINE_LOCATION)) {
                    val builder = AlertDialog.Builder(this@ChooseLocationActivity)
    ...
    private fun showGPSDisabledAlertToUser() {
        val alertDialogBuilder = AlertDialog.Builder(this@ChooseLocationActivity)
