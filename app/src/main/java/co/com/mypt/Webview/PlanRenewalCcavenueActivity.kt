...
class PlanRenewalCcavenueActivity : AppCompatActivity() {
    lateinit var webView:WebView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.activity_plan_renewal_ccavenue)
    ...
    private fun getCcavenueWeb() {
        ...
        var  api= ApiURL.payamount+intent.getStringExtra("price")
                            ...
                            url?.let {
                                when {
                                    it.contains("payment/success", ignoreCase = true) -> {
                                        ...
                                        val intent = Intent(this@PlanRenewalCcavenueActivity, BookingConfirmActivity::class.java)
                                    ...
                                    it.contains("payment/cancelled", ignoreCase = true) -> {
                                        val builder = AlertDialog.Builder(this@PlanRenewalCcavenueActivity)
