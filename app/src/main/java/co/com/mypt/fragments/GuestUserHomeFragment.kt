...
class GuestUserHomeFragment : Fragment(), View.OnTouchListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String, param3: String): GuestUserHomeFragment {
            val fragment = GuestUserHomeFragment()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_guest_user_home, container, false)
