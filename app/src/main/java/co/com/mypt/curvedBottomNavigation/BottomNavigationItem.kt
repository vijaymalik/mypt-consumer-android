...
import co.com.mypt.databinding.BottomNavigationItemBinding
...
class BottomNavigationItem @JvmOverloads constructor(
    ...
    val bottomNavigationUnselectedItems = mutableListOf(
        R.drawable.home,
        R.drawable.book,
        R.drawable.dumbbell,
        R.drawable.calendar,
    ...
    val bottomNavigationSelectedItems = mutableListOf(
        R.drawable.selected_home,
        R.drawable.selected_book,
        R.drawable.selected_dumbbell,
        R.drawable.selected_calendar,
        R.drawable.selected_menu,
    )
    ...
    var title = ""
        set(value) {
            ...
            if (allowDraw) {
                ...
                binding.titleTxtSelected.text = value
            }
    ...
    var titleTextSize = 0
        set(value) {
            ...
            if (allowDraw) {
                ...
                binding.titleTxtSelected.textSize = value.toFloat()
            }
        }
     ...
     var titleFont: Typeface? = null
        set(value) {
            ...
            if (allowDraw && field != null) {
                ...
                binding.titleTxtSelected.typeface = value
            }
        }
    ...
    fun unselectedItem(isAnimate: Boolean = true, i: Int) {
        if (isItemSelected)
            animateProgress(false, isAnimate)
        isItemSelected = false
        binding.titleTxt.visible()

        binding.titleTxtSelected.gone()
        binding.titleTxtSelected.setTextColor(resources.getColor(R.color.white))
        ...
        binding.iconIv.setImageResource(bottomNavigationUnselectedItems[i])
    }

    fun selectedItem(isAnimate: Boolean = true, i: Int) {
        if (!isItemSelected){
        ...
        binding.titleTxtSelected.visible()
        binding.titleTxtSelected.setTextColor(resources.getColor(R.color.orangecolor))
        ...
        binding.iconIv.setImageResource(bottomNavigationSelectedItems[i])
    ...
    private fun animateProgress(enableCell: Boolean, isAnimate: Boolean = true) {
        ...
        /*val animation: Animation =
            AnimationUtils.loadAnimation(context, R.anim.shake_error)
        binding.fabView.startAnimation(animation)*/
