...
class CurvedBottomNavigation : FrameLayout {
    ...
    var heightBottomNaviagtion = 80.dp(context)
        set(value) {
            field = value
            updateAllIfAllowDraw()
        }
    ...
    var backgroundBottomColor = Color.parseColor("#101113")
        set(value) {
            field = value
            updateAllIfAllowDraw()
        }
    ...
    private var shadowColor = Color.parseColor("#101113")
    ...
    fun show(id: Int, enableAnimation: Boolean = true) {
        ...
        for (i in models.indices) {
            ...
            if (model.id == id) {
                ...
                cell.selectedItem(enableAnimation,i)
                onShowListener(model)
            } else {
                cell.unselectedItem(hasAnimation,i)
            }
        }
        selectedId = id
    }
