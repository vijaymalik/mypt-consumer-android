...
class DayCalAdapter(
...
) : RecyclerView.Adapter<DayCalAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val distanceFromCenter = itemCenterX - recyclerCenterX

        val maxRotation = 25f // Max angle for side texts
        val radius = recyclerView.height * 1.3f // Adjust for curvature
